; ModuleID = 'probe6.1c221ef95259541a-cgu.0'
source_filename = "probe6.1c221ef95259541a-cgu.0"
target datalayout = "e-m:e-p:32:32-p10:8:8-p20:8:8-i64:64-n32:64-S128-ni:1:10:20"
target triple = "wasm32-unknown-unknown"

; core::f64::<impl f64>::is_subnormal
; Function Attrs: inlinehint nounwind
define internal zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17hb3e9b8e17f5db734E"(double %self) unnamed_addr #0 {
start:
...
define hidden void @_ZN6probe65probe17he0682dcb99f6f699E() unnamed_addr #1 {
start:
; call core::f64::<impl f64>::is_subnormal
  %_1 = call zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17hb3e9b8e17f5db734E"(double 1.000000e+00) #2
  ret void
}
